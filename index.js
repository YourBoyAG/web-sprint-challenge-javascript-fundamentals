...
// Because from within myFunction, the nestedFunction is 
// called before myFunction which allows it to source the variables 
...
function summation(number) {
  let count = 0;
  for(var i = 0; i < number; i++, count += 1){
    count += i
  }
  return count
}
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const newArray = array.map((animal) => animal.animal_name.toLowerCase())
    return newArray;
  }
  ...
  */
  ...
  function lowPopulationAnimals(array){
      const newArray = array.filter(animal => animal.population < 5)
      return newArray
    };
  ...
  */
  ...
  function USApop(array){
    const newArray = array.reduce((acc, animal) => acc + animal.population, 0)
    return newArray
  }
